...
public class Demo1 {
    ...
    private static void simpleReadJsonFromString() throws IOException {
    ...
    private static void readObjectWithUnknownProperties() throws IOException {
    ...
    private static void readValuesToList() throws IOException {
    ...
    private static void navigatingByJsonAsNodeTree() throws IOException {
    ...
    private static void useJsonCreatorAnnotation() throws IOException {
